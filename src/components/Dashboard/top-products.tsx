export default function TopProducts() {
    return (
      <div className="bg-card shadow-md rounded-lg p-4 sm:p-6 h-full overflow-x-auto">
          ...
          <table className="w-full">
            ...
            <tbody>
              <tr>
                ...
                <td className="py-3">
                  <span className="text-xs font-medium text-[#4079ed] border border-[#4079ed] bg-[#f0f9ff] px-4 py-1 rounded-md">45%</span>
                </td>
              </tr>
              <tr>
                ...
                <td className="py-3">
                  <span className="text-xs font-medium text-[#05c283] border border-[#05c283] bg-[#e2fff3] px-4 py-1 rounded-md">29%</span>
                </td>
              </tr>
              <tr>
                ...
                <td className="py-3">
                  <span className="text-xs font-medium text-[#bf83ff] border border-[#bf83ff] bg-[#f3e8ff] px-4 py-1 rounded-md">18%</span>
                </td>
              </tr>
              <tr>
                ...
                <td className="py-3">
                  <span className="text-xs font-medium text-[#ff8900] border border-[#ff8900] bg-[#fff4de] px-4 py-1 rounded-md">25%</span>
                </td>
              </tr>
            </tbody>
          </table>
